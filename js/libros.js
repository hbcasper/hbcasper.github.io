	...
	$('.guardar').click(function() {
		...
		if (inputsVacios.length == 0) {
			if (selectsVacios.length == 0) {
				...
				var nuevo = "<div id='r"+registro.rid+"'><strong>Título: " + registro.titulo + "</strong><br>Id: " + registro.id 
					+ "<br>ISBN: " + registro.isbn + "<br>Editorial: " + registro.editorial + "<br>Edición: " + registro.edicion + "</div>";
				...
				var btnEditar = $('<button/>',
				{
					...
					id:registros.length,
					type:'button',
					'class':'btn btn-primary btn-md pull-right editar',
					click: function () { 
						rid = this.id;
